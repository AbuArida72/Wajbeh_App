export const translations = {
  en: {
    ...
    priceTooHighBlock: "The bag price must be at least 50% off the original value. We're saving food that would be thrown away — not making a large profit.",
    priceLowerSuggestion: "Consider lowering the price to 75% off or more. This makes the bag more accessible to people who need it and helps ensure the food doesn't go to waste.",
    ...
    repeatNoteText: "This bag will be posted for {count} consecutive days with the same settings.",
  ...
  ar: {
    ...
    priceTooHighBlock: "يجب أن يكون سعر الحقيبة أقل بنسبة 50% على الأقل من القيمة الأصلية. نحن نوفر طعامًا كان سيُرمى — لا نسعى لتحقيق أرباح كبيرة.",
    priceLowerSuggestion: "فكّر في تخفيض السعر بنسبة 75% أو أكثر. هذا يجعل الحقيبة في متناول من يحتاجها ويضمن عدم هدر الطعام.",
    ...
    repeatNoteText: "سيتم نشر هذا الكيس لمدة {count} أيام متتالية بنفس الإعدادات.",
